## cherryctl server upgrade

Upgrade a virtual server.

### Synopsis

Attempt to upgrade the plan of a virtual server.

```
cherryctl server upgrade ID --plan <plan_slug> [flags]
```

### Examples

```
  # Upgrade the specified server:
